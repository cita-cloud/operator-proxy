...
var file_api_node_node_proto_rawDesc = []byte{
	...
	0x53, 0x74, 0x6f, 0x70, 0x70, 0x65, 0x64, 0x10, 0x09, 0x32, 0xdc, 0x01, 0x0a, 0x0b, 0x4e, 0x6f,
	...
	0x2f, 0x61, 0x70, 0x69, 0x2f, 0x6e, 0x6f, 0x64, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_api_node_node_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
...
var file_api_node_node_proto_depIdxs = []int32{
	...
	2, // 7: node.NodeService.Init:output_type -> node.NodeSimpleResponse
	4, // 8: node.NodeService.List:output_type -> node.NodeList
	2, // 9: node.NodeService.Start:output_type -> node.NodeSimpleResponse
	7, // 10: node.NodeService.Stop:output_type -> google.protobuf.Empty
